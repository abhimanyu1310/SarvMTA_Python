...
class Sarv(object):
    ...
    def cast_error(self, result):
        '''Take a result representing an error and cast it to a specific exception if possible (use a generic sarv.Error exception for unknown cases)'''
